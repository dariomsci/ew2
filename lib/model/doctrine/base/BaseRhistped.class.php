...
Doctrine_Manager::getInstance()->bindComponent('Rhistped', 'doctrine');
 ...
 * @method Rhistped setNroped()   Sets the current record's "nroped" value
 * @method Rhistped setNroren()   Sets the current record's "nroren" value
 * @method Rhistped setCodent()   Sets the current record's "codent" value
 * @method Rhistped setFecha()    Sets the current record's "fecha" value
 * @method Rhistped setCodart()   Sets the current record's "codart" value
 * @method Rhistped setValatr1()  Sets the current record's "valatr1" value
 * @method Rhistped setValatr2()  Sets the current record's "valatr2" value
 * @method Rhistped setValatr3()  Sets the current record's "valatr3" value
 * @method Rhistped setValatr4()  Sets the current record's "valatr4" value
 * @method Rhistped setCantidad() Sets the current record's "cantidad" value
 * @method Rhistped setPrecio()   Sets the current record's "precio" value
 * @method Rhistped setPorcbon()  Sets the current record's "porcbon" value
 * @method Rhistped setImpsub()   Sets the current record's "impsub" value
 * @method Rhistped setCanpes()   Sets the current record's "canpes" value
 * @method Rhistped setCodage()   Sets the current record's "codage" value
 * @method Rhistped setCanxenv()  Sets the current record's "canxenv" value
 * @method Rhistped setCantpal()  Sets the current record's "cantpal" value
 * @method Rhistped setPbonif1()  Sets the current record's "pbonif1" value
 * @method Rhistped setPbonif2()  Sets the current record's "pbonif2" value
 * @method Rhistped setPrecbon()  Sets the current record's "precbon" value
 * @method Rhistped setCodemp()   Sets the current record's "codemp" value
 * @method Rhistped setCodcom()   Sets the current record's "codcom" value
 * @method Rhistped setCodtal()   Sets the current record's "codtal" value
 * @method Rhistped setNumero()   Sets the current record's "numero" value
 * @method Rhistped setFecent()   Sets the current record's "fecent" value
 * @method Rhistped setLugent()   Sets the current record's "lugent" value
 * @method Rhistped setCoddes()   Sets the current record's "coddes" value
 * @method Rhistped setCodfam()   Sets the current record's "codfam" value
 * @method Rhistped setCodsfa()   Sets the current record's "codsfa" value
 * @method Rhistped setCantcan()  Sets the current record's "cantcan" value
 * @method Rhistped setCantapl()  Sets the current record's "cantapl" value
 * 
 * @package    jobeet
 * @subpackage model
 ...
 */
abstract class BaseRhistped extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('rhistped');
