...
Doctrine_Manager::getInstance()->bindComponent('Rencbtef', 'doctrine');
 ...
 * @method Rencbtef setId()      Sets the current record's "id" value
 * @method Rencbtef setCodemp()  Sets the current record's "codemp" value
 * @method Rencbtef setCodcom()  Sets the current record's "codcom" value
 * @method Rencbtef setCodtal()  Sets the current record's "codtal" value
 * @method Rencbtef setNumero()  Sets the current record's "numero" value
 * @method Rencbtef setNroren()  Sets the current record's "nroren" value
 * @method Rencbtef setCodigo()  Sets the current record's "codigo" value
 * @method Rencbtef setCodres()  Sets the current record's "codres" value
 * @method Rencbtef setFecha()   Sets the current record's "fecha" value
 * @method Rencbtef setHora()    Sets the current record's "hora" value
 * @method Rencbtef setDescom()  Sets the current record's "descom" value
 * @method Rencbtef setLetra()   Sets the current record's "letra" value
 * @method Rencbtef setTorig()   Sets the current record's "torig" value
 * @method Rencbtef setNorig()   Sets the current record's "norig" value
 * @method Rencbtef setForig()   Sets the current record's "forig" value
 * @method Rencbtef setImporte() Sets the current record's "importe" value
 * @method Rencbtef setDetalle() Sets the current record's "detalle" value
 * 
 * @package    jobeet
 * @subpackage model
 ...
 */
abstract class BaseRencbtef extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('rencbtef');
