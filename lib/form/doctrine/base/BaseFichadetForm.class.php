...
/**
 * Fichadet form base class.
 *
 * @method Fichadet getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 */
abstract class BaseFichadetForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'numpre'  => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'descom'  => new sfValidatorString(array('max_length' => 10, 'required' => false)),
      'numpre'  => new sfValidatorString(array('max_length' => 13, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('fichadet[%s]');
