...
/**
 * Rhistped form base class.
 *
 * @method Rhistped getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 */
abstract class BaseRhistpedForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('rhistped[%s]');
