...
/**
 * Cpedxweb form base class.
 *
 * @method Cpedxweb getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 */
abstract class BaseCpedxwebForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'totpes'   => new sfValidatorInteger(array('required' => false)),
      'codcpag'  => new sfValidatorInteger(array('required' => false)),
      'docref'   => new sfValidatorString(array('max_length' => 30, 'required' => false)),
    ));

    $this->widgetSchema->setNameFormat('cpedxweb[%s]');
