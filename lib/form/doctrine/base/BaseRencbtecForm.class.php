...
/**
 * Rencbtec form base class.
 *
 * @method Rencbtec getObject() Returns the current form's model object
 *
 * @package    jobeet
 * @subpackage form
 ...
 */
abstract class BaseRencbtecForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('rencbtec[%s]');
